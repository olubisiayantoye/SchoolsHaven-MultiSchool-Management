...
class Upload_model extends MY_Model
{
    ...
    public function post_slider_image_upload($file)
    {
        $this->my_upload->upload($file);
        if ($this->my_upload->uploaded == true) {
            $this->my_upload->file_new_name_body = 'home-slider_image_1920x750_' . uniqid();
            $this->my_upload->image_convert = 'jpg';
            $this->my_upload->jpeg_quality = 85;
            ...
            $this->my_upload->image_y = 750;
            $this->my_upload->process('./assets/uploads/slider/');
            $destination = 'assets/uploads/slider/';
            //$destination = './uploads/images/';
           // $image_path = "assets/uploads/slider/" . $this->my_upload->file_dst_name;
    ...
    public function post_student_image_upload($file)
    {
        //var_dump("expre okkk"); die();
        $this->my_upload->upload($file);
        if ($this->my_upload->uploaded == true) {
            $this->my_upload->file_new_name_body = 'home-student_image_300x300_' . uniqid();
            $this->my_upload->image_convert = 'jpg';
            $this->my_upload->jpeg_quality = 85;
            $this->my_upload->image_ratio_crop = true;
            $this->my_upload->image_resize = true;
            ...
            //var_dump("expression photo"); die();
        $this->my_upload->process('./assets/uploads/student-photo/');
