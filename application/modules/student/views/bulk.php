...
<p><font size="8">New Admission should start from: </font><font color="red" size="30" style="bold" id="adm_no"></font></p>                          
...
<!-- datatable with buttons -->
 <script type="text/javascript">
    ...
    function get_new_number(school_id){
