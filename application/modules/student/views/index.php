...
//echo $CI->genetrate_student_id(1) ; die();

 //echo $generate_id; die();
?>
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">
               ...
               <option value="<?php echo site_url('student/index/'); ?>">--<?php echo $this->lang->line('select'); ?>--</option> 
                            ...
                            <?php }else{ ?> 
                                <select  class="form-control col-md-7 col-xs-12 auto-width" name="school_id_filter" id="school_id_filter" onchange="get_yearby_school(this.value,'')">
                      ...
                      <select  class="form-control col-md-7 col-xs-12 auto-width" name="year_id_filter" id="year_id_filter" onchange="get_class_by_year(this.value,'')"  >
                    ...
                    <div class="tab-content">
                                ...
                                <tbody>   
                                    <?php  $count = 1; if(isset($students) && !empty($students)){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <th><?php echo $obj->admission_no; ?></th>
                                            <td><b><?php echo ucfirst($obj->surname); ?></b> <?php echo ucfirst($obj->name); ?></td>
                                            <td><?php $obj->phone // echo $this->lang->line($obj->group); ?></td>
                        ...
                        <?php if(has_permission(EDIT, 'student', 'student')){ ?>
                                    <!--start this is to ensure only in current academic year students be disenroll-->                
                                         <?php //if(@$current_acada = 1){?>
                                         <a href="<?php echo site_url('student/edit/'.$obj->id); ?>" class="btn btn-info btn-xs"><i class="fa fa-pencil-square-o"></i> <?php echo $this->lang->line('edit'); ?> </a>
                                           <button type="button" class="btn btn-danger" data-id="<?php echo $obj->id; ?>" onclick="confirmDelist(this);">Delist</button>  
                                         <?php //} ?>  
                                       <!--end this is to ensure only in current academic year students be disenroll-->    
                                               ...
                                               <?php if(has_permission(VIEW, 'student', 'student')){ ?>
                                                        <a href="javascript:void(0);" onclick="get_student_modal(<?php echo $obj->id; ?>);"  data-toggle="modal" data-target=".bs-student-modal-lg" class="btn btn-success btn-xs"><i class="fa fa-eye"></i> <?php echo $this->lang->line('view'); ?> </a>
                                                          ...
                                                          <a href="javascript:void(0);" onclick="get_student_modal_card(<?php echo $obj->id; ?>);"  data-toggle="modal" data-target=".bs-student-modal-lg" class="btn btn-success btn-xs"><i class="fa fa-eye"></i> <?php echo $this->lang->line('view'); ?> ID-CARD </a>
                                                    <?php } ?>
                        ...
                        <div  class="tab-pane fade in <?php if(isset($add)){ echo 'active'; }?>" id="tab_add_student">
                                ...
                                <div class="row">                  
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="surname"><?php echo $this->lang->line('surname'); ?> <span class="required">*</span></label>
                                            <input  class="form-control col-md-7 col-xs-12"  name="surname"  id="surname" value="<?php echo isset($post['surname']) ?  $post['surname'] : ''; ?>" placeholder="<?php echo $this->lang->line('surname'); ?>" required="required" type="text" autocomplete="off">
                                            <div class="help-block"><?php echo form_error('surname'); ?></div> 
                                        </div>
                                    </div>
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="admission_no"><?php echo $this->lang->line('admission_no'); ?> <span class="required"></span><?php //echo $new_admission; ?> </label>
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        ...
                                        <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="place_of_birth"><?php echo $this->lang->line('place_of_birth'); ?> <span class="required">*</span></label>
                                            <input  class="form-control col-md-7 col-xs-12"  name="place_of_birth"  id="place_of_birth" value="<?php echo isset($post['place_of_birth']) ?  $post['place_of_birth'] : ''; ?>" placeholder="<?php echo $this->lang->line('place_of_birth'); ?>" required="required" type="text" autocomplete="off">
                                            <div class="help-block"><?php echo form_error('place_of_birth'); ?></div> 
                                        </div>
                                    </div>
                                       <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="nationality"><?php echo $this->lang->line('nationality'); ?> <span class="required">*</span></label>
                                            <input  class="form-control col-md-7 col-xs-12"  name="nationality"  id="nationality" value="<?php echo isset($post['nationality']) ?  $post['nationality'] : ''; ?>" placeholder="<?php echo $this->lang->line('nationality'); ?>" required="required" type="text" autocomplete="off">
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                             ...
                                             <input  class="form-control col-md-7 col-xs-12"  name="phone"  id="add_phone" value="<?php echo isset($post['phone']) ?  $post['phone'] : ''; ?>" placeholder="<?php echo $this->lang->line('phone'); ?>"  type="text" autocomplete="off">
                          ...
                          <?php if($this->session->userdata('role_id') != SUPER_ADMIN){  ?> 
                         <input  class="form-control col-md-7 col-xs-12"  name="roll_no"  id="roll_no" value="<?php echo isset($post['roll_no']) ?  $post['roll_no'] : @$generate_id; ?>" readonly="readonly" placeholder="<?php echo $this->lang->line('roll_no'); ?>" required="required" type="text" autocomplete="off"> <?php }else{ ?>
                        <input  class="form-control col-md-7 col-xs-12"  name="roll_no"  id="roll_no" value="<?php echo isset($post['roll_no']) ?  $post['roll_no'] : ''; ?>" readonly="readonly" placeholder="<?php echo $this->lang->line('roll_no'); ?>" required="required" type="text" autocomplete="off">   
        ...
        <div class="item form-group">
        <label for="surname"><?php echo $this->lang->line('surname'); ?> <span class="required">*</span></label>
        <input  class="form-control col-md-7 col-xs-12"  name="surname"  id="surname" value="<?php echo isset($student->surname) ?  $student->surname : ''; ?>" placeholder="<?php echo $this->lang->line('surname'); ?>" required="required" type="text" autocomplete="off">
        <div class="help-block"><?php echo form_error('surname'); ?></div> 
        </div>
        </div>
                     ...
                     <input  class="form-control col-md-7 col-xs-12"  name="name"  id="name" value="<?php echo isset($student->name) ?  $student->name : ''; ?>" placeholder="<?php echo $this->lang->line('name'); ?>" required="required" type="text" autocomplete="off">
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="place_of_birth"><?php echo $this->lang->line('place_of_birth'); ?> <span class=""></span></label>
                                            <input  class="form-control col-md-7 col-xs-12"  name="place_of_birth"  id="place_of_birth" value="<?php echo isset($student->place_of_birth) ?  $student->place_of_birth : ''; ?>" placeholder="<?php echo $this->lang->line('place_of_birth'); ?>"  type="text" autocomplete="off">
                                            <div class="help-block"><?php echo form_error('place_of_birth'); ?></div> 
                                        </div>
                                    </div>
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="nationality"><?php echo $this->lang->line('nationality'); ?> <span class=""></span></label>
                                            <input  class="form-control col-md-7 col-xs-12"  name="nationality"  id="nationality" value="<?php echo isset($student->nationality) ?  $student->nationality : ''; ?>" placeholder="<?php echo $this->lang->line('nationality'); ?>"  type="text" autocomplete="off">
                                            <div class="help-block"><?php echo form_error('nationality'); ?></div> 
                                        </div>
                                    </div>
                                ...
                                <div class="row"> 
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <div class="item form-group">
                                            <label for="guardian_id"><?php echo $this->lang->line('guardian'); ?> <span class=""></span></label>
                                            <select  class="form-control col-md-7 col-xs-12 quick-field" name="guardian_id" id="edit_guardian_id" onchange="get_guardian_by_id(this.value);">
                                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                                <?php foreach($guardians as $obj){ ?>
                                    ...
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                             <label for="phone"><?php echo $this->lang->line('phone'); ?> <span class=""></span></label>
                                             <input  class="form-control col-md-7 col-xs-12"  name="phone"  id="add_phone" value="<?php echo isset($student->phone) ?  $student->phone : ''; ?>" placeholder="<?php echo $this->lang->line('phone'); ?>" type="text" autocomplete="off">
                                             <div class="help-block"><?php echo form_error('phone'); ?></div>
                                         </div>
                                     </div>
                                ...
                                <div class="row">                  
                                     ...
                                     <div class="col-md-3 col-sm-3 col-xs-12">
                                         <div class="item form-group">
                                            ...
                                            <input  class="form-control col-md-7 col-xs-12"  name="password"  id="password" value="<?php //echo isset($student->password) ?  $student->password : ''; ?>" placeholder="<?php //echo $this->lang->line('password'); ?>" type="text" autocomplete="off">
                                            <div class="help-block"><?php echo form_error('password'); ?></div>
                                         </div>
                                     </div>
                                     <!------password---->
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h4 class="modal-title">Delist Student</h4>
                <button type="button" class="close" data-dismiss="modal">×</button>
            </div>
 
            <div class="modal-body">
                <h4>Are you sure you want Remove tnis student from this current acedemic year ?</h4>
               <h3> If YES, the student will NOT be enroll for this current session But the student previous results will be intact</h3>  
        <form method="POST" action="<?php echo site_url('student/disenrollment'); ?>" id="form-delete-user">
                    <input type="hidden" name="id">
                    <?php
                   $FourDigitRandomNumber = mt_rand(1111,9999);
                 echo "<h4>Type this confirmation code: ".$FourDigitRandomNumber."</h4>";
               ?>
               <input type="hidden" name="code" value=" <?php echo $FourDigitRandomNumber;
               ?>" >
                    
                    <input type="number" name="confirmationcode" required>
    <?php if(isset($filter_school_id) && isset($class_id)&& isset($year_id)){ ?>
 <input type="hidden" name="school_id" value="<?php echo $filter_school_id;?>">
 <input type="hidden" name="year_id" value="<?php echo $year_id;?>">       
    <?php } ?>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" form="form-delete-user" class="btn btn-danger">Disenroll</button>
            </div>
...
<?php if (isset($new_admission)) {  ?>
   <script type="text/javascript">

document.getElementById("admission_no").value = '<?php echo $new_admission; ?>';
document.getElementById("roll_no").value = '<?php echo $generate_id; ?>';
...
<script type="text/javascript">
    ...
    function get_student_modal(student_id){
     ...
     function get_student_modal_card(student_id){
         
        $('.fn_student_data').html('<p style="padding: 20px;"><p style="padding: 20px;text-align:center;"><img src="<?php echo IMG_URL; ?>loading.gif" /></p>');
        $.ajax({       
          type   : "POST",
          url    : "<?php echo site_url('student/get_single_student_card'); ?>",
          data   : {student_id : student_id},  
          success: function(response){                                                   
             if(response)
             {
...
<!-- Super admin js START  -->
 <script type="text/javascript">
    ...
    $('.fn_school_id').on('change', function(){
      ...
      $.ajax({       
            type   : "POST",
            url    : "<?php echo site_url('ajax/generate_id'); ?>",
      ...
      $.ajax({       
            type   : "POST",
            url    : "<?php echo site_url('ajax/newfrom_max_admission'); ?>",
            data   : { school_id:school_id },               
            async  : false,
            success: function(response){                                                   
               if(response)
...
<!-- datatable with buttons -->
 ...
 <script type="text/javascript">
    ...
    function get_class_by_year(year_id , class_id){
                
        $.ajax({       
            type   : "POST",
            url    : "<?php echo site_url('ajax/get_class_by_year'); ?>",
     ...
     function generate_student_id(school_id){
    ...
    function get_last_admission_no(school_id){
        ...
        $.ajax({       
         ...
         function get_yearby_school(school_id){
        
        
        $.ajax({       
            type   : "POST",
            url    : "<?php echo site_url('ajax/get_year_by_school'); ?>",
            data   : { school_id:school_id },               
            async  : false,
            success: function(response){                                                   
               if(response)
    ...
    <?php if(isset($filter_school_id) && isset($class_id)&& isset($year_id)){ ?>
        ...
        generate_student_id('<?php echo $filter_school_id; ?>');
    <?php } ?>
    ...
    function get_student_by_class_sa(class_id){
        ...
        var year_id = $('#year_id_filter').val();
        if( !school_id){
         ...
         if( !year_id){
           ...
           toastr.error('<?php echo $this->lang->line('select'); ?> <?php echo $this->lang->line('year'); ?>');
           return false;
        }         
        if(!class_id){
            return false;
        }        
       window.location.href = '<?php echo site_url('student/index/'); ?>'+class_id+'/'+school_id+'/'+year_id; 
    }
