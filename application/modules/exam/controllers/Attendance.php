...
class Attendance extends MY_Controller {
  ...
  echo '<script type="text/javascript">'.'alert("'.$this->lang->line('instruction').' : '.'Please ensure You ADD STUDENTS to the class OR ensure Exam Schedules before Exam Attendance Entry'.'")'.'</script>';
				} 
