    ...
    * ********************************************************** */
    public function index() {
        ...
        if ($_POST) {
            ...
            $this->data['result_comments'] = $this->mark->get_exam_comments($school_id, $exam_id, $class_id, $section_id, $student_id, $school->academic_year_id);
        ...
        if($this->session->userdata('role_id') != SUPER_ADMIN){ 
            ...
            $condition2['id'] = $school->academic_year_id;
            $condition2['school_id'] = $this->session->userdata('school_id');
            $this->data['academic_years'] = $this->mark->get_list('academic_years', $condition2, '', '', '', 'id', 'ASC'); 
