    ...
    <div class="col-md-12">
        <table class="table table-bordered">
            <thead>
                ...
                <?php 
                //echo $obj->section_id.'okkk'; die();
           // $subjects = $this->db->get_where('subjects' , array('school_id' => $school_id, 'class_id' => $class_id, 'section_id' => $obj->section_id ))->result_array();
                    foreach($subjects as $subj):
                ?>
                    <td style="text-align: center;"><?php echo $subj->name;?></td>
                <?php endforeach;?>
            ...
            ?>
                <tr>
                    <td style="text-align: center;">
                        <?php echo $row->student; // $this->db->get_where('student' , array('student_id' => $row['student_id']))->row()->name;?>
