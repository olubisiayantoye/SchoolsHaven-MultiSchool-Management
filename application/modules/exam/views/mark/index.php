...
<div class="row">
 ...
 <?php echo $current_acada; if(@$current_acada == 1  ) { ?>
...
<li  class="<?php if(isset($upload)){ echo 'active'; }?>"><a href="#tab_upload_mark"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('upload'); ?> <?php echo $this->lang->line('mark'); ?></a> </li> <?php } ?>
            ...
            <div class="tab-content">
                        <div  class="tab-pane fade in <?php if(isset($list)){ echo 'active'; }?>" id="tab_mark_list" >
                                ...
                                <th rowspan="3">
                                <b><?php echo $this->lang->line('surname'); ?></b> / <?php echo $this->lang->line('name'); ?>
                ...
                <th>Obtainable Mark<input name="" type="text" value="<?php echo ($total_cas + $class_ass->exam_mark) ;?>" class="form-control form-mark col-md-7 col-xs-12 fn_mark_total" required="required" readonly /></th>
						   ...
						   echo "<th>".$this->lang->line('obtained').' '.$this->lang->line('mark').' '." &#8681;</th>";
						    ...
						    ?>                                            
                               ...
                               <!-- just label obatainable mark ##############################################end-->                                          
                                ...
                                <td><?php echo '<strong>'.ucfirst($obj->surname).'</strong>';//ucfirst($obj->student_name); ?> / <?php echo ucfirst($obj->student_name); ?>
                    ...
                    <input type="hidden" value="<?php echo $obb[3];?>"  name="viva_mark" />
          ...
          </div>  <!--llllllllllllllltogglr tabllllllllllllllllll-->
    ...
    <?php }else{ ?>
<h2>You can no longer manage students marks in OLD academy year</h2>
<h2>You have to activate current new academy year in order to manage mark  </h2>
<?php } ?>         
...
get_subject_by_section('<?php echo $section_id; ?>','<?php echo $class_id; ?>');
    <?php } ?>

function get_subject_by_section(section_id,class_id){ 
 var school_id = $('#school_id').val();
 if (class_id == ''){
    //alert(class_id);
