                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <ul>
<li>Speak/Fluency:<br/>
<input  type="number" max="5" min="0"  value="<?php if(isset($result) && $result->speak_fluency != ''){ echo $result->speak_fluency; } ?>"  name="speak_fluency[<?php echo $obj->id; ?>]" class="form-control col-md-7 col-xs-12"  autocomplete="off"/>
</li>
<li>Punctual/neatness:<br/>
<input  type="number" max="5" min="0" value="<?php if(isset($result) && $result->punctua_neat != ''){ echo $result->punctua_neat; } ?>"  name="punctua_neat[<?php echo $obj->id; ?>]" class="form-control col-md-7 col-xs-12"  autocomplete="off"/>
<li>Attentiveness:<br/>
<input  type="number" max="5" min="0"  value="<?php if(isset($result) && $result->attentiveness != ''){ echo $result->attentiveness; } ?>"  name="attentiveness[<?php echo $obj->id; ?>]" class="form-control col-md-7 col-xs-12"  autocomplete="off"/>
<li>Games:<br/>
<input  type="number" max="5" min="0" value="<?php if(isset($result) && $result->games != ''){ echo $result->games; } ?>"  name="games[<?php echo $obj->id; ?>]" class="form-control col-md-7 col-xs-12"  autocomplete="off"/>
<li>handwritting:<br/>
<input  type="number" max="5" min="0"  value="<?php if(isset($result) && $result->handwritting != ''){ echo $result->handwritting; } ?>"  name="handwritting[<?php echo $obj->id; ?>]" class="form-control col-md-7 col-xs-12"  autocomplete="off"/>
<li>Music/fineart:<br/>
<input  type="number" max="5" min="0"  value="<?php if(isset($result) && $result->music_fineart != ''){ echo $result->music_fineart; } ?>"  name="music_fineart[<?php echo $obj->id; ?>]" class="form-control col-md-7 col-xs-12"  autocomplete="off"/>
</ul>       
                                    </td>                                     
                                    <td> 
...
<textarea name="general_comment[<?php echo $obj->id; ?>]" rows="3" cols="100" class="form-control col-md-7 col-xs-12" ><?php if(isset($result->general_comment) && $result->general_comment != ''){ echo $result->general_comment; }?></textarea>
                                    ...
                                    <td>
      <input type="text" value="<?php if(isset($result) && $result->conduct != ''){ echo $result->conduct; } ?>"  name="conduct[<?php echo $obj->id; ?>]" class="form-control col-md-7 col-xs-12"  autocomplete="off"/>
                                    </td>  
                                    <td>
       <input type="text" value="<?php if(isset($result) && $result->attendance != ''){ echo $result->attendance; } ?>"  name="attendance[<?php echo $obj->id; ?>]" class="form-control col-md-7 col-xs-12"  autocomplete="off"/>
                                    </td>
   
                                    <td>
       <input type="text" value="<?php if(isset($result) && $result->class_position != ''){ echo $result->class_position; } ?>"  name="class_position[<?php echo $obj->id; ?>]" class="form-control col-md-7 col-xs-12"  autocomplete="off"/>
       </td>
                                </tr>
                            <?php } ?>
                        <?php }else{ ?>
