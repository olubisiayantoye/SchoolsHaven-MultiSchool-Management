                        ...
                        if (isset($students) && !empty($students)) {
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <input class="form-control col-md-7 col-xs-12 " type="text" name="avg_grade_point[<?php echo $obj->id; ?>]" value="<?php echo @number_format($mark->total_point/$mark->total_subject,2); ?>333" style="width: 60px;"  autocomplete="off"/>
                                    </td>
                                    ...
                                    <td>
       <input type="text" value="<?php if(isset($result) && $result->remark != ''){ echo $result->remark; } ?>"  name="remark[<?php echo $obj->id; ?>]" class="form-control col-md-7 col-xs-12"  autocomplete="off"/>
       </td>
                                </tr>
                            <?php } ?>
                        <?php }else{ ?>
