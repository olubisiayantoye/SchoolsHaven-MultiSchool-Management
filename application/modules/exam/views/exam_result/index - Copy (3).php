                        ...
                        if (isset($students) && !empty($students)) {
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php echo @number_format($mark->exam_mark/$mark->total_subject,2); ?>
                                    </td>
                                    
                                    <td>
     									<?php echo @number_format($mark->obtain_mark/$mark->total_subject,2); ?>
                                       
                                    </td>                                
                                    <td>
                <?php $result = $CI->Marksheet_Model->get_grade(@number_format($mark->obtain_mark/$mark->total_subject,2),$class_id,$school_id ) ; echo $result["point"]; ?>
                                    </td>
                                      
                                    <td>
                                       <?php $result2 = $CI->Marksheet_Model->get_grade(@number_format($mark->obtain_mark/$mark->total_subject,2),$class_id,$school_id ) ; echo $result2["name"]; ?>
                                    </td>
   
                                    <td>
                            <input disabled="disabled" type="text" value="<?php $result3 = $CI->Marksheet_Model->get_grade(@number_format($mark->obtain_mark/$mark->total_subject,2),$class_id,$school_id ) ; echo $result3["note"]; ?>"  name="" class="form-control col-md-7 col-xs-12" />
       								</td>
                                </tr>
                            <?php } ?>
                        <?php }else{ ?>
