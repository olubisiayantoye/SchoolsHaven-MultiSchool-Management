    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <?php echo form_open(site_url('exam/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <?php echo "copy/paste -> your term Exam ".$this->session->userdata('runing_session'); ?>
                                        <input  class="form-control col-md-7 col-xs-12"  name="title"  id="title" value="<?php echo isset($post['title']) ?  $post['title'] : ''; ?>" placeholder="<?php echo isset($post['title']) ?  $post['title'] : 'Term Exam '.$this->session->userdata('runing_session'); ?>" placeholder="<?php echo $this->lang->line('exam'); ?> <?php echo $this->lang->line('title'); ?>" required="required" type="text" autocomplete="off">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <span>carefully select term that applys to the Title of your exam</span>
                                ...
                                <option value="Third Term">Third Term Examination</option>
                                
                                <option value="Mock_First_Term">Mock-First Term Exam</option>
                                <option value="Mock_Second_Term">Mock-Second Term Exam</option>
                                <option value="Mock_Third_Term">Mock-Third Term Exam</option>
                                
                                </select>
                                    <div class="help-block"><?php echo form_error('term'); ?></div>
                                </div>
                            </div>
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12">Year</label>
                                 <div class="col-md-6 col-sm-6 col-xs-12">
            <?php //echo  $year    = $this->db->get_where('settings' , array('type' => 'running_year'))->row()->description; ?>
           
            <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input disabled="disabled" type="text" class="form-control col-md-7 col-xs-12" name="" value=" <?php echo $this->session->userdata('runing_session'); ?>"/>
            ...
            <div class="help-block"></div>
                            ...
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12">Term Period(in Days) </label>
                                 <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="number"  class="form-control col-md-7 col-xs-12" name="term_period"/>
                                    <div class="help-block"></div>
                                </div>
                            </div>
                           <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12">Another or Next term begins</label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="date" class="form-control col-md-7 col-xs-12" name="next_term_begins"/>
                                    <div class="help-block"></div>
                                </div>
                            </div>
                            
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12">Total Attendance </label>
                                 <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="number"  class="form-control col-md-7 col-xs-12" name="total_attendance"/>
                                    <div class="help-block"></div>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane fade in active" id="tab_edit_exam">
                            ...
                            <div class="item form-group">
                                ...
                                <option value="First Term" <?php echo $Val = ($exam->term == "First Term") ? "selected" : "" ; ?> >First Term Examination</option>
<option value="Second Term"  <?php echo $Val = ($exam->term == "Second Term") ? "selected" : "" ; ?> >Second Term Examination</option>
<option value="Third Term"  <?php echo $Val = ($exam->term == "Third Term") ? "selected" : "" ; ?>  >Third Term Examination</option>
                                </select>
                                   <div class="help-block"></div>
                                </div>
                            </div>
            ...
            <?php //echo  $year    = $this->db->get_where('settings' , array('type' => 'running_year'))->row()->description; ?>
            <div class="col-md-6 col-sm-6 col-xs-12">
              <?php  $running_year       =   $this->db->get_where('academic_years' , array('id' =>$exam->academic_year_id))->row()->session_year ?>
                                    <input disabled="disabled" type="text" class="form-control col-md-7 col-xs-12" name="" value="<?php echo $running_year ; ?>"/>
                                    <div class="help-block"></div>
                                </div>
            ...
            <div class="help-block"></div>
                            ...
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12">Term Period(in Days) </label>
                                 <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="number" value="<?php echo isset($exam->term_period) ?  $exam->term_period : $post['term_period']; ?>"  class="form-control col-md-7 col-xs-12" name="term_period"/>
                                    <div class="help-block"></div>
                                </div>
                            </div>
                           <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12">Another or Next term begins</label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="date" value="<?php echo isset($exam->next_term_begins) ?  date('d-m-Y', strtotime($exam->next_term_begins)) : $post['next_term_begins']; ?>" class="form-control col-md-7 col-xs-12" name="next_term_begins"/>
                                    <div class="help-block"></div>
                                </div>
                            </div>
                            ...
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12">Total Attendance </label>
                                 <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="number" value="<?php echo isset($exam->total_attendance) ?  $exam->total_attendance : $post['total_attendance']; ?>" class="form-control col-md-7 col-xs-12" name="total_attendance"/>
                                    <div class="help-block"></div>
                                </div>
                            </div>
