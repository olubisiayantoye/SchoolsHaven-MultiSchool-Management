                                ...
                                <tbody>   
                                    <?php $count = 1; if(isset($operations) && !empty($operations)){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $obj->is_upload_vissible == 1 ? 'Y' :'--'; ?></td>
                        ...
                        <div  class="tab-pane fade in <?php if(isset($add)){ echo 'active'; }?>" id="tab_add_operation">
                            <div class="x_content"> 
                               <?php echo form_open(site_url('setting/operation/add'), array('name' => 'operation', 'id' => 'operation', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="is_upload_vissible">is_upload_vissible <span class="required">*</span>
                                    </label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="is_upload_vissible" value="1"   type="checkbox" > 
                                        <div class="help-block"><?php echo form_error('is_upload_vissible'); ?></div>
                                    </div>
                                </div>
                               ...
                               <?php echo form_open(site_url('setting/operation/edit'), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                  ...
                                  <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="is_upload_vissible" value="1"   type="checkbox" <?php echo isset($operation->is_upload_vissible) && $operation->is_upload_vissible == 1  ? 'checked="checked"' :'' ?>> 
                                        <div class="help-block"><?php echo form_error('is_upload_vissible'); ?></div>
                                    </div>
                                </div>
