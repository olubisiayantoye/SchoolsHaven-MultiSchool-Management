                            ...
                            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                ...
                                <tbody>   
                                    <?php $count = 1; if(isset($pin) && !empty($pin)){ ?>
                                        ...
                                        <tr>
                                         <td><input type="checkbox" id="checkItem1" name="check1[]" value="<?php echo $obj->pin_id; ?>">
                                         </td>
                               ...
                               <p align="center">
  <button type="submit" class="btn btn-success" name="action1" value="block">BLOCK</button> 		  <button type="submit" class="btn btn-success" name="action1" value="delete">DELETE</button>
              </p>
</form>
...
$("input[name='check1[]']").not(this).prop('checked', this.checked);
});
</script>
