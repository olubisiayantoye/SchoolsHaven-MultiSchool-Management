                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane fade in active" id="tab_paypal_setting">                         
                                                ...
                                                <div class="item form-group">
                                                 ...
                                                 <div class="item form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input  class="form-control col-md-7 col-xs-12"  name="paypal_extra_charge" value="<?php echo isset($payment_setting) ? $payment_setting->paypal_extra_charge : ''; ?>"  placeholder="<?php echo $this->lang->line('paypal'); ?> <?php echo $this->lang->line('extra_charge'); ?>" type="text" autocomplete="off">
                                            ...
                                            <div class="tab-pane fade in " id="tab_pumoney_setting">                          
                                                ...
                                                <div class="item form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input  class="form-control col-md-7 col-xs-12"  name="payu_extra_charge" value="<?php echo isset($payment_setting) ? $payment_setting->payu_extra_charge : ''; ?>"  placeholder="<?php echo $this->lang->line('payumoney'); ?> <?php echo $this->lang->line('extra_charge'); ?>" type="text" autocomplete="off">
                                            ...
                                            <div class="tab-pane fade in " id="tab_paytm_setting">                          
                                                ...
                                                <div class="item form-group">
                                                    ...
                                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                                        <input  class="form-control col-md-7 col-xs-12"  name="paytm_extra_charge" value="<?php echo isset($payment_setting) ? $payment_setting->paytm_extra_charge : ''; ?>"  placeholder="<?php echo $this->lang->line('paytm'); ?> <?php echo $this->lang->line('extra_charge'); ?>" type="text" autocomplete="off">
