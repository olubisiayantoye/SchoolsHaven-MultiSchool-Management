...
<th><?php echo $this->lang->line('upload'); ?>  &nbsp;<input type="checkbox" id="fn_upload"  class="role-check" value="1" /></th>
                                        ...
                                        <?php if(isset($operations) && !empty($operations)){ ?>
                                            ...
                                            <tr>           
                                                ...
                                                <td>
                                                    ...
                                                    <?php } ?>
                                                 <td>
                                                    <?php if($op->is_upload_vissible){ ?>
                                                        <input type="checkbox" class="fn_upload"  name="is_upload[<?php echo $op->id; ?>]" value="1" <?php if(isset($permission->is_upload) && $permission->is_upload == 1){ echo 'checked="checked"'; } ?> /></td>
                                                    <?php } ?>    
...
<!-- datatable with buttons -->
 <script type="text/javascript">
        ...
        $('#fn_add').click(function(){
		 ...
		 $('#fn_upload').click(function(){
           if($(this).is(':checked')){           
               $(".fn_upload").prop("checked", true);
           }else{
              $(".fn_upload").prop("checked", false);
           }
        });
