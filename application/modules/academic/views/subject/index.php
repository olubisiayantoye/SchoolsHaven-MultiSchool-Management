            ...
            <div class="x_content">
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <div class="tab-content">
                                ...
                                <tbody>   
                                    <?php $count = 1; if(isset($subjects) && !empty($subjects)){ ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
											<?php 
											if (isset($obj->section_id) && !empty($obj->section_id)) {
											
											$ccl= explode(":",$obj->section_id);
											$ccl2 = array_filter($ccl);
											$lenth = count($ccl2);
											echo '<ul>';
											$CI =& get_instance();
											//$CI->load->model('Section_Model', 'section', true);
											for($xx= 0; $xx < $lenth;$xx++){
											$result= $CI->section->get_single_section($ccl[$xx])->name;  
											echo '<li><b>'.$result.'</b><br></li>';
											}
											echo '</ul>';
											} 	
											?></td>
                               ...
                               <?php echo form_open(site_url('academic/subject/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input autocomplete="on"  class="form-control col-md-7 col-xs-12"  name="name"  id="name" value="<?php echo isset($post['name']) ?  $post['name'] : ''; ?>" placeholder="<?php echo $this->lang->line('subject'); ?> <?php echo $this->lang->line('name'); ?>" required="required" type="text" autocomplete="on">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="code"  id="code" value="<?php echo isset($post['code']) ?  $post['code'] : ''; ?>" placeholder="<?php echo $this->lang->line('code'); ?>"  type="text" autocomplete="on">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="author"  id="author" value="<?php echo isset($post['author']) ?  $post['author'] : ''; ?>" placeholder="<?php echo $this->lang->line('author'); ?>"  type="text" autocomplete="on">
                       ...
                       <div class="col-md-6 col-sm-6 col-xs-12" id="add_section_id">
                            ...
                            <div class="x_content"> 
                               <?php echo form_open(site_url('academic/subject/edit/'.$subject->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="name"  id="name" value="<?php echo isset($subject->name) ?  $subject->name : $post['name']; ?>" placeholder="<?php echo $this->lang->line('subject'); ?> <?php echo $this->lang->line('name'); ?>" required="required" type="text" autocomplete="on">
                                        <div class="help-block"><?php echo form_error('name'); ?></div>
                                    </div>
                                </div>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="code"  id="code" value="<?php echo isset($subject->code) ?  $subject->code : $post['code']; ?>" placeholder="<?php echo $this->lang->line('subject'); ?> <?php echo $this->lang->line('code'); ?>" type="text" autocomplete="on">
                                        <div class="help-block"><?php echo form_error('code'); ?></div>
                                    </div>
                                </div>
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="author"  id="author" value="<?php echo isset($subject->author) ?  $subject->author : $post['author']; ?>" placeholder="<?php echo $this->lang->line('author'); ?>"  type="text" autocomplete="on">
                                        <div class="help-block"><?php echo form_error('author'); ?></div>
                                    </div>
                                </div>
                                <div class="item form-group">
                                ...
                                <div class="item form-group">
                                 ...
                                 <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12" id="edit_section_id">
...
<script type="text/javascript">
    ...
    function get_subject_modal(subject_id){
        ...
        $.ajax({       
          type   : "POST",
          url    : "<?php echo site_url('check_exam/pin/get_single_pin'); ?>",
...
<!-- Super admin js START  -->
 <script type="text/javascript">
	...
	$.ajax({       
            type   : "POST",
             url    : "<?php echo site_url('ajax/get_section_by_class2'); ?>",
            data   : { school_id:school_id,  class_id : class_id },               
            async  : false,
            success: function(response){                                                   
               if(response)
