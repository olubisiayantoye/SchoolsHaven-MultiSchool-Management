                        ...
                        if (isset($students) && !empty($students)) {
                            ...
                            <?php  $position = get_position_in_class($school_id, $academic_year_id, $current_class_id, $obj->id); ?>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $obj->surname.' '.ucfirst($obj->name); ?></td>
                                    ...
                                    <td>
<input style="color: red;"  type="number" value="<?php if(isset($enroll)){ echo $enroll->roll_no;}else{ echo rand( 10000 , 99999 ); } ?>"   name="roll_no[<?php echo $obj->id; ?>]"  class="form-control col-md-7 col-xs-12 small-field" required="required"  autocomplete="off"/>
                                    </td>
                                    <td>
    <select class="form-control" name="promote_status[<?php echo $obj->id; ?>]">
                                    <option value="0">Do not Promote</option>
                                    <option value="1">Promote</option>
                                    <option value="2">Left the School</option>
                            </select>
                                    </td>    
                                </tr>
                            <?php } ?>
...
<?php }else{ ?>
<h2>You cannot promote students untill you have started a new academy year</h2>
<h2>You have to create new academy year in order to do promotion  </h2>
<?php } ?>
