...
class Promotion extends MY_Controller {
    ...
    public function index() {                
        ...
        if($this->session->userdata('role_id') != SUPER_ADMIN){ 
            ...
            $this->data['curr_session'] = $this->promotion->get_list('academic_years', array('id' => $school->academic_year_id, 'school_id'=>$condition['school_id']));
            ...
            $latestacademic_id = $this->promotion->get_single('academic_years', array('school_id'=>$this->session->userdata('school_id')))->id;
    ...
    public function add() {                
        ...
        if($_POST){
            ...
            $next_class_default_section = $this->promotion->get_single('sections', array('school_id'=>$school_id, 'class_id'=>$next_class_id));
            ...
            if(!empty($_POST['students'])){
                ...
                foreach($_POST['students'] as $key=>$value){
                       ...
                       // need to check is any student alredy enrolled
                        ...
                        $promote_status = $_POST['promote_status'][$value]; 
                       ...
                       if(empty($exist)){ 
                            ...
                            $data['created_by'] = logged_in_user_id();          if($promote_status == 1){
