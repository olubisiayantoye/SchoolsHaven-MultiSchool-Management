                        ...
                        <?php if(has_permission(ADD, 'guardian', 'guardian')){ ?>
                            <?php if(isset($edit)){ ?>
                             ...
                             <?php }else{ ?>
                                ...
                                <?php if(has_permission(UPLOAD, 'guardian', 'guardian')){ ?>
<li  class="<?php if(isset($upload)){ echo 'active'; }?>"><a href="#tab_upload_guardian"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('upload'); ?> <?php echo $this->lang->line('guardian'); ?></a> </li> <?php } ?>
                    ...
                    <div class="tab-content">
                        ...
                        <!--///////////////////////////////////////////////////////////////////////////////--> 
                        <div  class="tab-pane fade in <?php if(isset($upload)){ echo 'active'; }?>" id="tab_upload_guardian">
                        <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('guardians/bulk/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="row">                                      
                                    ...
                                    <?php if($this->session->userdata('role_id') == SUPER_ADMIN){ ?>
                                     ...
                                     <div class="col-md-2 col-sm-2 col-xs-12">
                                         <div class="item form-group">
                                             <label for="">&nbsp;</label>
                                            <a href="<?php echo ASSET_URL; ?>csv/bulk_guardians.csv"  class="btn btn-success btn-md"><?php echo $this->lang->line('generate_csv'); ?></a>
                                         </div>
                                     </div> 
                                    <div class="col-md-2 col-sm-2 col-xs-12">
                                         <div class="item form-group">
