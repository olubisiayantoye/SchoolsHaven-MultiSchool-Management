                    ...
                    <div class="page-banner-cont">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><?php echo $this->lang->line('notice'); ?> <?php echo $this->lang->line('detail'); ?></li>
                            </ol>
                        </nav>
        ...
        <div class="row">
            <div class="col-lg-8 col-md-12 col-sm-12 col-12">
                <div class="page-notice">
                    ...
                    <p class="text"><?php echo $notice->notice; ?></p>
                </div>
            </div>
