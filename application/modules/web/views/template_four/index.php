    ...
    <section class="pt-115 pb-120 gray-bg">
        <div class="container">
            <div class="row align-items-end">
                ...
                <div class="col-lg-6 col-md-4 col-sm-5">
                    <div class="products-btn text-right pb-60">
                        <a href="#" class="main-btn">All Notices</a>
                    </div> <!-- products btn -->
                </div>
            </div> <!-- row -->
                        ...
                        <div class="col-lg-4 col-md-8">
                            ...
                            <a href="#"><img src="images/admission/admission-1.jpg" alt="Admission"></a>
                                ...
                                <div class="card-content">
                                    <h4 class="card-titles"><?php echo $obj->title; ?></h4>
                                    <p><?php echo implode(' ', array_slice(explode(' ', $obj->notice), 0, 50)); ?></p>
                                   <p><?php echo strlen($obj->title); ?></p>
                                   <p><a href="#" class="main-btn">READ MORE</a></p>
                                </div>
                            </div> <!-- admission card -->
                        </div>
                <?php } ?> 
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="category-text pt-40">
                            <h2>Best school to learn everything</h2>
                        </div>
                    </div>
   ...
   <!--====== COURSE PART START ======-->
    ...
    <section id="course-part" class="pt-115 pb-115 gray-bg">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="section-title pb-45">
                     ...
                     <div class="section-title pb-45">
                        <a href="#" class="main-btn">All Photo</a>
                    </div> <!-- products btn -->
                </div>
            ...
            <div class="row course-slide mt-30">
                <div class="col-lg-4">
                    <div class="single-course-2">
                        <div class="thum">
                            <div class="image">
                                <img src="<?php echo ASSET_URL; ?>theme_bin/images/publication/p-1.jpg" alt="Course">
                            </div>
                            <div class="price">
                                <span>image</span>
                            </div>
                ...
                <div class="col-lg-4">
                    <div class="single-course-2">
                        <div class="thum">
                            <div class="image">
                                <img src="<?php echo ASSET_URL; ?>theme_bin/images/publication/p-2.jpg" alt="Course">
                            </div>
                            <div class="price">
                                <span>Image</span>
                            </div>
                ...
                <div class="col-lg-4">
                    <div class="single-course-2">
                        <div class="thum">
                            <div class="image">
                                <img src="<?php echo ASSET_URL; ?>theme_bin/images/publication/p-3.jpg" alt="Course">
                            </div>
                            <div class="price">
                                <span>Free</span>
                            </div>
                            <div class="course-teacher">
                                <div class="thum">
                                    <a href="courses-single.html"><img src="<?php echo ASSET_URL; ?>theme_bin/images/publication/p-1.jpg" alt="teacher"></a>
                                </div>
                                <div class="name">
                                    <a href="#"><h6>Mark Anthem</h6></a>
                                </div>
