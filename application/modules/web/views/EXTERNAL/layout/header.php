            ...
            <div class="row">
               ...
               <?php if($this->session->userdata('role_id') == SUPER_ADMIN){
                            ...
                            <?php echo form_open_multipart(site_url('visitor/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <select  class="form-control col-md-7 col-xs-12"  name="role_id"  id="edit_role_id" required onchange="change_school(this.value);">
                    ...
                    <div class="menu">
                        <nav id="mobile_menu_active">
                            <ul id="menu">
                               ...
                               <li><a href="<?php echo site_url('elearning'); ?>">E-Learning</a></li>
