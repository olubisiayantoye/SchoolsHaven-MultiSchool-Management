                            ...
                            <div class="x_content"> 
                               ...
                               <div class="item form-group">
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <textarea  class="form-control col-md-7 col-xs-12 summernote"  name="news"  id="news" required="required" placeholder="<?php echo $this->lang->line('news'); ?>"><?php echo isset($post['news']) ?  $post['news'] : ''; ?></textarea>
                            ...
                            <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('announcement/news/edit/'.$news->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="news"><?php echo $this->lang->line('news'); ?> <span class="required">*</span></label>
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <textarea  class="form-control col-md-7 col-xs-12 summernote"  name="news"  id="news" required="required" placeholder="<?php echo $this->lang->line('news'); ?>"><?php echo isset($news->news) ?  $news->news : $post['news']; ?></textarea>
                                        <div class="help-block"><?php echo form_error('news'); ?></div>
                                    </div>
                                </div>
