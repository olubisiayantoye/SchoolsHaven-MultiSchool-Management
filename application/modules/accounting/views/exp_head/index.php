                            ...
                            <div class="x_content"> 
                               <?php echo form_open(site_url('accounting/exphead/edit/'.$exphead->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <input  class="form-control col-md-7 col-xs-12"  name="title"  id="title" value="<?php echo isset($exphead->title) ?  $exphead->title : $post['title']; ?>" placeholder="<?php echo $this->lang->line('expenditure_head'); ?>" required="required" type="text" autocomplete="off">
                                        <div class="help-block"><?php echo form_error('title'); ?></div>
                                    </div>
                                </div>
