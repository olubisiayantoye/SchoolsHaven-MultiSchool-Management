...
<li  class="<?php if(isset($upload)){ echo 'active'; }?>"><a href="#tab_upload_mark"  role="tab"  data-toggle="tab" aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('upload'); ?> <?php echo $this->lang->line('mark'); ?></a> </li> <?php } ?>
            ...
            <div class="tab-content">
                        <div  class="tab-pane fade in <?php if(isset($list)){ echo 'active'; }?>" id="tab_mark_list" >
                                ...
                                <th rowspan="3"><?php echo $this->lang->line('photo'); ?></th>
                                <?php
                                ...
                                <th rowspan="3"><?php echo $this->lang->line('grade'); ?></th>                                            
                                ...
                                <tr>
                                  ...
                                  <th colspan="2">yyyyyy</th>
                                  <th colspan="2">eee</th>
                                  <th colspan="2">rrrr</th>
                                </tr>
                        ...
                        <div class="x_content"> 
                               <?php echo form_open_multipart(site_url('mark/bulk/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="row">                                      
                                     ...
                                     <div class="col-md-2 col-sm-2 col-xs-12">
                                         <div class="item form-group">
                                             <label for="">&nbsp;</label>
                                            <a href="<?php echo ASSET_URL; ?>csv/bulk_mark.csv"  class="btn btn-success btn-md"><?php echo $this->lang->line('generate_csv'); ?></a>
                                         </div>
                                     </div> 
                                    <div class="col-md-2 col-sm-2 col-xs-12">
                                         <div class="item form-group">
