...
public function student_exists_mark($school_id,$exam_id,$class_id,$section_id,$subject_id,$academic_year_id,$student_id)
		{
			...
			public function update_change_insection($school_id,$exam_id,$class_id,$academic_year_id,$subject_id,$section_id){
				$data = array(
				...
				public function update_change_insection_attendance($school_id,$exam_id,$class_id,$academic_year_id,$subject_id,$section_id){
				$data = array(
				'section_id' => $section_id,
				'is_attend' => 1
				);
