    ...
    public function edit($id = null) {
        ...
        if ($_POST) {
            ...
            if ($this->form_validation->run() === TRUE) {
                ...
                $updated2 = $this->employee->update('users', $data2, array('id' => $this->input->post('user_id')));
                }

                if ($this->input->post('role_id')) {
                $data3['role_id'] = $this->input->post('role_id');
                $updated3 = $this->employee->update('users', $data3, array('id' => $this->input->post('user_id')));
                }
