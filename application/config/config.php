...
*/
		...
		$username = "root";
		$password = "1234";
		$dbname = "schoolshavenmultischooldb";
		...
		$sql = "SELECT id, school_name,  school_code FROM schools WHERE id = 1";
		...
		while($row = $result->fetch_assoc()) {
			if ($sname == $row["school_name"]){
			//echo "id: " . $row["id"]. " - Name: " . $row["school_name"]. " " . $row["school_code"].""."". "<br>";
			$site_id = $row["id"];
			//var_dump($result->num_rows);die();
			 break;
			}
...
//}
 ...
 $config['base_url'] =  'http://localhost/SchoolsHaven-MultiSchool-Management';
