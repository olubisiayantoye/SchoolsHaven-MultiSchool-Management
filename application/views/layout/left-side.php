                ...
                <ul class="nav side-menu">                    
                    ...
                    <?php if(has_permission(VIEW, 'exam', 'grade') || has_permission(VIEW, 'exam', 'exam')){ ?> 
                     <?php if($this->session->userdata('role_id') == SUPER_ADMIN){ ?>   
                        ...
                        <li><a <?php if(empty($classes)){ ?> onclick="toastr.error('<?php echo $this->lang->line('class_add_alert'); ?>');" <?php } ?>><i class="fa fa-graduation-cap"></i> <?php echo $this->lang->line('exam'); ?> <span class="fa fa-chevron-down"></span></a>
                            <ul class="nav child_menu">
                             <?php //foreach($classes as $obj){ ?>
                                <?php if(has_permission(VIEW, 'exam', 'grade')){ ?>
                                    <li><a href="<?php echo site_url('exam/grade/index/'.@$obj->id); ?>"><?php echo $this->lang->line('exam_grade'); ?></a></li>                         
                                <?php } ?>
                                <?php if(has_permission(VIEW, 'exam', 'exam')){ ?>
                                    <li><a href="<?php echo site_url('exam/index/'.@$obj->school_id); ?>"><?php echo $this->lang->line('exam_term'); ?></a></li>                         
                                <?php } ?> 
                              <?php //} ?>
                            </ul>
                        </li>
                    ...
                    <?php if(has_permission(VIEW, 'exam', 'schedule')){ ?>                        
                        ...
                        <?php }else{ ?>
                            <li>
                            <a <?php if(empty($classes)){ ?> onclick="toastr.error('<?php echo $this->lang->line('class_add_alert'); ?>');" <?php } ?>><i class="fa fa-thumb-tack"></i><?php echo $this->lang->line('exam'); ?> <?php echo $this->lang->line('schedule'); ?> <span class="fa fa-chevron-down"></span></a>
                                <ul class="nav child_menu">                                                          
                                    <?php foreach($classes as $obj){ ?>
                                        <?php if($this->session->userdata('role_id') == STUDENT && $this->session->userdata('class_id') == $obj->id){ ?>
                    ...
                    <?php } ?>    
                       ...
                       <?php if(has_permission(VIEW, 'exam', 'mark') ||
					   		   has_permission(VIEW, 'exam', 'generalremark') || 
                               has_permission(VIEW, 'exam', 'examresult') || 
                               has_permission(VIEW, 'exam', 'finalresult') ||
                               has_permission(VIEW, 'exam', 'tabulationsheet') || 
                        ...
                        <li><a><i class="fa fa-file-text-o"></i> <?php echo $this->lang->line('exam_mark'); ?> <span class="fa fa-chevron-down"></span></a>
                            <ul class="nav child_menu">
                                ...
                                <?php if(has_permission(VIEW, 'exam', 'generalremark')){ ?>
                                    <li><a href="<?php echo site_url('exam/generalremark'); ?>"><?php echo $this->lang->line('general_remark'); ?></a></li>
                                <?php } ?>
                                ...
                                <?php if(has_permission(VIEW, 'exam', 'tabulationsheet')){ ?>
                                    <li><a href="<?php echo site_url('exam/tabulationsheet'); ?>"><?php echo $this->lang->line('exam_tabulation_sheet'); ?></a></li>
                                <?php } ?>
                    ...
                    <!--##############################-->
                     <?php if(has_permission(VIEW, 'checkexam', 'pin') 
					 
					 ){ ?>    
                        <li><a><i class="fa fa-book"></i> <?php echo 'Checking Exam Result'; ?> <span class="fa fa-chevron-down"></span></a>
                            <ul class="nav child_menu">
                                <?php if(has_permission(VIEW, 'checkexam', 'pin')){ ?>
                                    <li><a href="<?php echo site_url('checkexam/pin/index/'); ?>"><?php echo 'Manage E-PIN '; ?></a></li>
                                <?php } ?>
                   ...
                   <?php } ?>
                    ...
                    <?php } ?>
                     ...
                     <hr>
            <li> <a><i class="fa fa-dashboard"></i><strong>E- Library</strong></a></li>
             
             <?php if(has_permission(VIEW, 'academic', 'elibrary')){ ?> 
                       <li><a  href="<?php echo site_url('academic/elibrary/index'); ?>"><i class="fa fa-file-text-o"></i> <?php echo "E-library Resources"; ?></a> </li> 
            <?php } ?>
                   
                  <hr>
                    <li> <a><i class="fa fa-dashboard"></i><strong>Website Manager</strong></a></li>
