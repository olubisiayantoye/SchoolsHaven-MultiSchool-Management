...
<?php 
//var_dump( $section_id);
$phyco = $this->db->get_where('exam_results' , array('student_id' => $student_id,'exam_id' => $exam_id,'section_id' => $section_id))->row(); 
//var_dump($phyco);
...
//Example Usage
  ...
  <tr>
    ...
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td><strong>Class Population:<?php echo @$class_population; //$this->db->where('class_id' , $class_id);
                /*$this->db->where('year' , $running_year);
	            $this->db->from('enroll');
