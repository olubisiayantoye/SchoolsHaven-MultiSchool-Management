...
<br />
    ...
    $CI->checkmyresult_model->delete_duplicate_mark($school_id, $exam_id, $section_id, $student_id, $obj->subject_id, $academic_year_id);                        
                            ?>
                            <?php 
$position = get_position_in_subject($school_id, $exam_id, $class_id, $section_id, $obj->subject_id , $obj->obtain_total_mark); 
$position_mark= $obj->obtain_total_mark;
...
$result = $CI->checkmyresult_model->get_grade($obj->obtain_total_mark,$class_id,$school_id ) ; echo $result["name"]; 
 		                ...
 		                @$mark2 = round(@$position_mark,0);
		              @$grade_name = $CI->checkmyresult_model->get_grade(@$mark2,$class_id,$school_id ) ; echo @$grade_name["name"];
...
<br>
<?php 
$phyco = $this->db->get_where('exam_results' , array('school_id' => $school_id,'student_id' => $student_id,'section_id' => $section_id,'exam_id' => $exam_id))->row();
