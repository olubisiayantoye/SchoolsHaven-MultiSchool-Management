    ...
    <div class="nav_menu">
        <nav>
            ...
            <div class="col-md-5">
                ...
                <?php   if($this->session->userdata('role_id') != SUPER_ADMIN){ ?>
                        <li><a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-globe"></i><?php if(!empty($this->session->userdata('runing_session')))
						{ echo $this->session->userdata('runing_session'); }else{ echo 'set acadamic year'; } ;?></a>
                              <!--ul class="dropdown-menu dropdown-usermenu pull-right">
                              <li> <a href="">Session Year 2019/2020</a></li> -->
