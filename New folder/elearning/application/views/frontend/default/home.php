<?php 
/*if(defined('SITE_ID2')){
$banner_image = get_frontend_schoolsettings()->about_image;
$banner_title = get_frontend_schoolsettings()->school_name;
$banner_sub_title = get_frontend_schoolsettings()->about_text;
}else{
    $banner_image = get_frontend_settings('banner_image');
    $banner_title = get_frontend_settings('banner_title');
    $banner_sub_title = get_frontend_settings('banner_sub_title');
} */
if(defined('school_name')){
$school_name=school_name;
}else{
$school_name="School Haven";
}

if(defined('school_color')){
...
<section class="home-banner-area" style="background-image: url('<?= base_url("uploads/system/".$banner_image); ?>');
        ...
        <div class="row">
            <div class="col">
                <div class="home-banner-wrap">
                    <h1><font color="<?php echo $school_color; ?>"><?php echo $school_name; ?></font></h1>
