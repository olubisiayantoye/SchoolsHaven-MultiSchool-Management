    ...
    <div class="container-fluid">
        ...
        <ul class="list-unstyled topbar-right-menu float-right mb-0">
            ...
            <?php if (strtolower($this->session->userdata('role')) == 'superadmin'): ?>
                <!-- settings-->
                <a href="<?php echo site_url('superadmin/system_settings'); ?>" class="dropdown-item notify-item">
...
<div class="visit_website">
    ...
    <?php echo @$this->db->get_where('esettings' , array('school_id'=>$this->session->userdata('school_id')))->row()->system_name; ?>
        
    </h4>
    <a href="<?php echo site_url('home'); ?>" target="" class="btn btn-outline-light ml-3"><?php echo get_phrase('visit_website'); ?></a>
    <a href="<?php echo base_url2; ?>" target="" class="btn btn-outline-light ml-3"><?php echo get_phrase('school_website'); ?></a>
    <a href="<?php echo base_url3; ?>" target="" class="btn btn-outline-light ml-3"><?php echo get_phrase('School Portal'); ?></a>
</div>
</div>
</div>
<!-- end Topbar -->