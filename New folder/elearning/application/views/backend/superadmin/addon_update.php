        ...
        <div class="card">
            <div class="card-body">
                <h4 class="page-title"> <i class="mdi mdi-webpack title_icon"></i> <?php echo get_phrase('addon_update'); ?>
                  <a href="<?php echo site_url('superadmin/addon'); ?>" class="btn btn-outline-primary btn-rounded alignToTitle"><?php echo get_phrase('ge_to_addon_list'); ?></a>
                </h4>
            </div> <!-- end card body-->
        </div> <!-- end card -->
    </div><!-- end col-->
        ...
        <div class="card">
            <div class="card-body">
                <div class="col-lg-12">
                    ...
                    <form action="<?php echo site_url('superadmin/addon/version_update'); ?>" method="post" enctype="multipart/form-data">
                        ...
                        <a href="<?php echo site_url('superadmin/addon'); ?>" class="btn btn-secondary float-left mdi mdi-arrow-left"><?php echo get_phrase('back'); ?></a>
                    </form>
                </div>
            </div> <!-- end card body-->
        </div>
