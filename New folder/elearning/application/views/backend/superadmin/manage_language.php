			...
			<div class="card-body">
				...
				<div class="tab-content">
							...
							<table class="table table-bordered table-centered mb-0">
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<a href="<?php echo site_url('superadmin/manage_language/edit_phrase/'.$language);?>"
												class="btn btn-info">
												<?php echo get_phrase('edit_phrase');?>
											</a>
											<a href="javascript::" onclick="confirm_modal('<?php echo site_url('superadmin/manage_language/delete_language/'.$language);?>')" class="btn btn-danger">
					...
					<div class="tab-pane" id="add" style="padding: 30px">
						<div class="row">
							<div class="col-xl-6">
                <form class="" action="<?php echo site_url('superadmin/manage_language/add_phrase') ?>" method="post">
                  ...
                  <button type="submit" class="btn btn-primary" name="button"><?php echo get_phrase('save'); ?></button>
					...
					<div class="tab-pane" id="add_lang" style="padding: 30px">
						<div class="row">
							<div class="col-xl-6">
								<form class="" action="<?php echo site_url('superadmin/manage_language/add_language'); ?>" method="post">
									<div class="form-group mb-3">
...
function updatePhrase(key) {
	...
	$.ajax({
		type : "POST",
		url  : "<?php echo site_url('superadmin/update_phrase_with_ajax'); ?>",
