<div class="row ">
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                <h4 class="page-title"> <i class="mdi mdi-apple-keyboard-command title_icon"></i> <?php echo get_phrase('schools'); ?></h4>
            </div> <!-- end card body-->
        </div> <!-- end card -->
    </div><!-- end col-->
</div>
                        ...
                        <div class="table-responsive-sm mt-4">
                            ...
                            foreach ($schools as $obj): ?>
                                        <tr class="gradeU">
                                            ...
                                            <td>
                <img src="<?php echo siteoneurl.'/assets/uploads/logo/'.$obj->logo  ;?>" alt="" height="50" width="50" class="img-fluid rounded-circle img-thumbnail">
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <div class="dropright dropright">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li>
                                                            <a class="dropdown-item" href="#" onclick="confirm_modal('<?php //echo site_url();?>superadmin/instructor_application/approve/<?php //echo $pending_application['id']; ?>');">
                                                                <?php //echo get_phrase('approve');?>
                                                            </a>
                                                        </li>
                                                        <li>
                                                            <a class="dropdown-item" href="#" onclick="confirm_modal('<?php //echo site_url();?>superadmin/instructor_application/delete/<?php //echo $pending_application['id']; ?>');">
