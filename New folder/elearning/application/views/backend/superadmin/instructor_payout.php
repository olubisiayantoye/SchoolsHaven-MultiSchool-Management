                ...
                <div class="tab-content">
                    <div class="tab-pane show active" id="completed-b1">
                        <div class="row justify-content-md-center">
                            <div class="col-xl-6">
                                <form class="form-inline" action="<?php echo site_url('superadmin/instructor_payout/filter_by_date_range') ?>" method="get">
                                    <div class="col-xl-10">
                                ...
                                <tbody>
                                    <?php foreach ($completed_payouts->result_array() as $key => $completed_payout):
                                        ...
                                        <tr class="gradeU">
                                            ...
                                            <td> <a href="<?php echo site_url('superadmin/invoice/'.$completed_payout['id']); ?>" class="btn btn-outline-primary btn-rounded btn-sm"><i class="mdi mdi-printer-settings"></i></a> </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
                            </table>
                                            ...
                                            <td style="text-align: center;">
                                              <?php if ($pending_payout['status'] == 0): ?>
                                                <?php if ($paypal_keys[0]['production_client_id'] != ""): ?>
                                                  <form action="<?php echo site_url('superadmin/paypal_checkout_for_instructor_revenue'); ?>" method="post">
                                                ...
                                                <?php endif; ?>
                                              <?php else: ?>
                                                <a href="<?php echo site_url('superadmin/invoice/'.$pending_payout['id']); ?>" class="btn btn-outline-primary btn-rounded btn-sm"><i class="mdi mdi-printer-settings"></i></a>
                                              <?php endif; ?>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
