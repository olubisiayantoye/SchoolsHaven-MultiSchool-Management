...
<form action="<?php echo site_url('superadmin/lessons/'.$param3.'/edit'.'/'.$param2); ?>" method="post" enctype="multipart/form-data">
...
function ajax_get_video_details(video_url) {
    ...
    if(checkURLValidity(video_url)){
        $.ajax({
            url: '<?php echo site_url('superadmin/ajax_get_video_details');?>',
            type : 'POST',
