...
<?php foreach ($uninstalled_themes as $key => $uninstalled_theme): ?>
  <div class="alert alert-info new-theme-alert" role="alert">
    ...
    <a href="<?php echo site_url('superadmin/install_theme/'.$uninstalled_theme); ?>" class="btn btn-primary btn-rounded float-right"><?php echo get_phrase('install').' '.ucfirst(substr($uninstalled_theme, 0, -4)).' '.get_phrase('theme'); ?></a>
  </div>
<?php endforeach; ?>
        ...
        <div class="card">
            <div class="card-body">
                <h4 class="page-title"> <i class="mdi mdi-apple-keyboard-command title_icon"></i> <?php echo get_phrase('theme_settings'); ?>
                  <a href="<?php echo site_url('/superadmin/available_addons'); ?>" class="btn btn-outline-primary btn-rounded alignToTitle"><i class="mdi mdi-plus"></i><?php echo get_phrase('get_new_themes'); ?></a>
                </h4>
            </div> <!-- end card body-->
        </div> <!-- end card -->
    </div><!-- end col-->
                        ...
                        <div class="card-body">
                          ...
                          <div class="">
                            ...
                            <?php else: ?>
                              ...
                              <a href = "javascript::" class="btn btn-icon btn-secondary float-right col-5" id = "" style="" style="margin-right:5px;" onclick="confirm_modal('<?php echo site_url('superadmin/theme_actions/remove/'.$installed_theme); ?>');">
...
function activate_theme(theme) {
  $.ajax({
    url: '<?php echo site_url('superadmin/theme_actions/activate/');?>',
    type : 'POST',
    data : {theme : theme},
