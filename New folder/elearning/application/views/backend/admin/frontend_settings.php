            ...
            <div class="card-body">
                ...
                <form class="required-form" action="<?php echo site_url('admin/frontend_settings/frontend_update'); ?>" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <input type="text" name = "banner_title" id = "banner_title" class="form-control" value="<?php if (!empty($fs->banner_title)){echo $fs->banner_title; }else{echo get_frontend_settings('banner_title'); } ?>" required>
                    </div>
                    <div class="form-group">
                        <label for="banner_sub_title"><?php echo get_phrase('banner_sub_title'); ?><span class="required">*</span></label>
                        <input type="text" name = "banner_sub_title" id = "banner_sub_title" class="form-control" value="<?php if (!empty($fs->banner_sub_title)){echo $fs->banner_sub_title; }else{echo get_frontend_settings('banner_sub_title');}  ?>" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="about_us" id = "about_us" class="form-control" rows="5"><?php if (!empty($fs->about_us)){echo $fs->about_us; }else{ echo get_frontend_settings('about_us');} ?></textarea>
                    </div>
                    <div class="form-group">
...
<div class="row justify-content-center">
    ...
    <?php if (!empty($fs->banner_image)){$bi = $fs->banner_image; }else{$bi = get_frontend_settings('banner_image');}  ?>

                                          <div class="js--image-preview" style="background-image: url(<?php echo base_url('uploads/system/'.$bi);?>); background-color: #F5F5F5;"></div>
                    ...
                    <div class="row justify-content-center">
                        <form action="<?php echo site_url('admin/frontend_settings/light_logo'); ?>" method="post" enctype="multipart/form-data" style="text-align: center;">
                            <div class="form-group mb-2">
                                <div class="wrapper-image-preview">
                                    <div class="box" style="width: 250px;">
<?php if (!empty($fs->light_logo)){$light_logo = $fs->light_logo; }else{$light_logo = get_frontend_settings('light_logo');}  ?>

                                        <div class="js--image-preview" style="background-image: url(<?php echo base_url('uploads/system/'.$light_logo); ?>); background-color: #F5F5F5;"></div>
                                        <div class="upload-options">
                    ...
                    <div class="row justify-content-center">
                        <form action="<?php echo site_url('admin/frontend_settings/dark_logo'); ?>" method="post" enctype="multipart/form-data" style="text-align: center;">
                            <div class="form-group mb-2">
                                <div class="wrapper-image-preview">
                                    <div class="box" style="width: 250px;">
<?php if (!empty($fs->dark_logo)){$dark_logo = $fs->dark_logo; }else{$dark_logo = get_frontend_settings('dark_logo');}  ?>

                                        <div class="js--image-preview" style="background-image: url(<?php echo base_url('uploads/system/'.$dark_logo); ?>); background-color: #F5F5F5;"></div>
                                        <div class="upload-options">
                    ...
                    <div class="row justify-content-center">
                        <form action="<?php echo site_url('admin/frontend_settings/small_logo'); ?>" method="post" enctype="multipart/form-data" style="text-align: center;">
                            <div class="form-group mb-2">
                                <div class="wrapper-image-preview">
                                    <div class="box" style="width: 250px;">
 <?php if (!empty($fs->small_logo)){$small_logo = $fs->small_logo; }else{$small_logo = get_frontend_settings('small_logo');}  ?>                                       
                        <div class="js--image-preview" style="background-image: url(<?php echo base_url('uploads/system/'.$small_logo); ?>); background-color: #F5F5F5;"></div>
                                        <div class="upload-options">
                    ...
                    <div class="row justify-content-center">
                        <form action="<?php echo site_url('admin/frontend_settings/favicon'); ?>" method="post" enctype="multipart/form-data" style="text-align: center;">
                            <div class="form-group mb-2">
                                <div class="wrapper-image-preview">
                                    <div class="box" style="width: 250px;">
<?php if (!empty($fs->favicon)){$favicon = $fs->favicon; }else{$favicon = get_frontend_settings('favicon');}  ?>                                        
                                        <div class="js--image-preview" style="background-image: url(<?php echo base_url('uploads/system/'.$favicon); ?>); background-color: #F5F5F5;"></div>
                                        <div class="upload-options">
