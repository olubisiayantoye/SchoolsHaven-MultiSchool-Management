...
<!-- third party css end -->
<!-- App css -->
<link href="<?php echo base_url('assets/backend/css/app-orange.css') ?>" rel="stylesheet" type="text/css" />
<!--link href="<?php //echo base_url('assets/backend/css/app-dark.css') ?>" rel="stylesheet" type="text/css" /-->
