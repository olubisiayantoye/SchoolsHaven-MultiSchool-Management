...
class Crud_model extends CI_Model
{
    ...
    public function get_categories($param1 = "",$school_id = "")
    {
        if ($param1 != "") {
    ...
    /////////////web settings//////////////
    public function check_schoolsetting_by_id($id)
    {
        return $this->db->get_where('esettings', array('school_id' => $id));
    }
    
    public function insert_schoolsetting_by_id($id)
    {
        $data['school_id'] = $id;
        $this->db->insert('esettings', $data);
    }
    /////////////end web settings//////////////

     /////////////FRONT web settings//////////////
    public function front_schoolsetting_by_id($id)
    {
        return $this->db->get_where('frontend_schoolsettings', array('school_id' => $id));
    }
    
    public function insert_front_schoolsetting_by_id($id)
    {
        $data['school_id'] = $id;
        $data['theme'] = "default";
        $this->db->insert('frontend_schoolsettings', $data);
    }
    /////////////end FRONT web settings//////////////
    ...
    public function add_category($school_id ="")
    {
...
////////school system settings////////////////////////////
    ...
    public function update_schoolsystem_settings()
    {
    $school_id = $this->session->userdata('school_id'); 
    $data['system_name'] = html_escape($this->input->post('system_name'));
    $data['system_title'] = html_escape($this->input->post('system_title'));
    $data['author'] = html_escape($this->input->post('author'));
    $data['slogan'] = html_escape($this->input->post('slogan'));
    $data['language'] = html_escape($this->input->post('language'));
    $data['text_align'] = html_escape($this->input->post('text_align'));
    $data['system_email'] = html_escape($this->input->post('system_email'));
    $data['address'] = html_escape($this->input->post('address'));
    $data['phone'] = html_escape($this->input->post('phone'));
    $data['youtube_api_key'] = html_escape($this->input->post('youtube_api_key'));
    $data['vimeo_api_key'] = html_escape($this->input->post('vimeo_api_key'));
    $data['footer_text'] = html_escape($this->input->post('footer_text'));
    $data['footer_link'] = html_escape($this->input->post('footer_link'));
    $data['website_keywords'] = html_escape($this->input->post('website_keywords'));
    $data['website_description'] = html_escape($this->input->post('website_description'));
    $data['student_email_verification'] = html_escape($this->input->post('student_email_verification'));
        $this->db->where('school_id', $school_id);
        $this->db->update('esettings', $data);
    }

////////end school system settings//////////////////
...
$data['school_id'] = $this->session->userdata('school_id');  
    ...
    public function update_frontend_settings()
    {
        ...
        public function update_frontend_schoolsettings()
    {
        $school_id = $this->session->userdata('school_id'); 
        $data['banner_title'] = html_escape($this->input->post('banner_title'));
        $data['banner_sub_title'] = html_escape($this->input->post('banner_sub_title'));
        $data['cookie_status'] = html_escape($this->input->post('cookie_status'));
        $data['cookie_note'] = $this->input->post('cookie_note');
        ...
        $this->db->where('school_id', $school_id);
        $this->db->update('frontend_schoolsettings', $data);
    }
    ...
    public function update_recaptcha_settings()
    {
     ...
     public function update_recaptcha_schoolsettings()
    {
        $school_id = $this->session->userdata('school_id');
        $data['recaptcha_status'] = html_escape($this->input->post('recaptcha_status'));
        $data['recaptcha_sitekey'] = html_escape($this->input->post('recaptcha_sitekey'));
        $data['recaptcha_secretkey'] = html_escape($this->input->post('recaptcha_secretkey'));
        $this->db->where('school_id', $school_id);
        $this->db->update('frontend_schoolsettings', $data);
    }
    ...
    public function update_frontend_banner()
    {
     ...
     public function update_frontend_schoolbanner()
    {
        $school_id = $this->session->userdata('school_id');
        if (isset($_FILES['banner_image']) && $_FILES['banner_image']['name'] != "") {
            unlink('uploads/system/' . get_frontend_settings('banner_image'));
            $data['banner_image'] = md5(rand(1000, 100000)).'_'.$school_id.'.jpg';
            $this->db->where('school_id', $school_id);
            $this->db->update('frontend_schoolsettings', $data);
            move_uploaded_file($_FILES['banner_image']['tmp_name'], 'uploads/system/'.$data['banner_image']);
        }
    }
    ...
    public function update_light_schoollogo()
    {
        $school_id = $this->session->userdata('school_id');
        if (isset($_FILES['light_logo']) && $_FILES['light_logo']['name'] != "") {
            unlink('uploads/system/' . get_frontend_settings('light_logo'));
            $data['light_logo'] = md5(rand(1000, 100000)).'_'.$school_id.'.png';
            $this->db->where('school_id', $school_id);
            $this->db->update('frontend_schoolsettings', $data);
            move_uploaded_file($_FILES['light_logo']['tmp_name'], 'uploads/system/'.$data['light_logo']);
        }
    }
    ...
    public function update_dark_schoollogo()
    {
        $school_id = $this->session->userdata('school_id');
        if (isset($_FILES['dark_logo']) && $_FILES['dark_logo']['name'] != "") {
            unlink('uploads/system/' . get_frontend_settings('dark_logo'));
            $data['dark_logo'] = md5(rand(1000, 100000)).'_'.$school_id.'.png';
            $this->db->where('school_id', $school_id);
            $this->db->update('frontend_schoolsettings', $data);
            move_uploaded_file($_FILES['dark_logo']['tmp_name'], 'uploads/system/'.$data['dark_logo']);
        }
    }
    ...
    public function update_small_schoollogo()
    {
        $school_id = $this->session->userdata('school_id');
        if (isset($_FILES['small_logo']) && $_FILES['small_logo']['name'] != "") {
            unlink('uploads/system/' . get_frontend_settings('small_logo'));
            $data['small_logo'] = md5(rand(1000, 100000)).'_'.$school_id.'.png';
            $this->db->where('school_id', $school_id);
            $this->db->update('frontend_schoolsettings', $data);
            move_uploaded_file($_FILES['small_logo']['tmp_name'], 'uploads/system/'.$data['small_logo']);
        }
    }
    ...
    public function update_favicon()
    {
     ...
     public function update_schoolfavicon()
    {
        $school_id = $this->session->userdata('school_id');
        if (isset($_FILES['favicon']) && $_FILES['favicon']['name'] != "") {
            unlink('uploads/system/' . get_frontend_settings('favicon'));
            $data['favicon'] = md5(rand(1000, 100000)).'_'.$school_id.'.png';
            $this->db->where('school_id', $school_id);
            $this->db->update('frontend_schoolsettings', $data);
            move_uploaded_file($_FILES['favicon']['tmp_name'], 'uploads/system/'.$data['favicon']);
        }
        //move_uploaded_file($_FILES['favicon']['tmp_name'], 'uploads/system/favicon.png');
    }
    ...
    function curl_request($code = '')
    {
        ...
        $personal_token = "FkAVV9SeUn";
        $url = "https://www.schoolshaven/sale?code=" . $product_code;
        $curl = curl_init($url);
        ...
        $verify_url = 'https://www.schoolshaven/user/verify-purchase:' . $product_code . '.json';
...
///////////////////////////////////////////////////////
      public function admim_get_courses($category_id = "", $sub_category_id = "", $instructor_id = 0)
    {
        
            $school_id = $this->session("school_id");
        if ($category_id > 0 && $sub_category_id > 0 && $instructor_id > 0) {
            return $this->db->get_where('course', array('category_id' => $category_id, 'sub_category_id' => $sub_category_id, 'user_id' => $instructor_id, 'school_id' => $school_id ));
        } elseif ($category_id > 0 && $sub_category_id > 0 && $instructor_id == 0) {
            return $this->db->get_where('course', array('category_id' => $category_id, 'sub_category_id' => $sub_category_id, 'school_id' => $school_id));
        } else {

        return $this->db->get_where('course', array( 'school_id' => $school_id));
        }
    }
...
//////////////////////////////////////////////////////////////////////
    ...
    public function XXfilter_course_for_backend($category_id, $instructor_id, $price, $status)
    {
    ...
    public function sort_question($question_json,$school_id="")
    {
...
$data['school_id'] = $this->session->userdata('school_id');  
    ...
    function sms_get_single($table_name, $index_array, $columns = null) {

        $ci2 = & get_instance();
        $db2 = $ci2->load->database('sms', TRUE);
        ...
        $db2->limit(1);
        $row = $db2->get_where($table_name, $index_array)->row();
        return $row;
    }

    public function sms_get_list($table_name, $index_array, $columns = null, $limit = null, $offset = 0, $order_field = null, $order_type = null) {
        ...
        if ($order_type) {
            $db2->order_by($order_field, $order_type);
        } else {
            $db2->order_by('id', 'DESC');
        }

        return $db2->get_where($table_name, $index_array)->result();
    }
