...
.btn {
    color: #fff;
    background-color: <?php echo $mycc; ?>;
    border-color: <?php echo $mycc; ?>;
    padding: 11px 12px;
    font-size: 15px;
    border-radius: 2px;
    line-height: 1.35135;
...
.search-box button:focus{
    background-color: <?php echo $mycc; ?> !important;
    border-color: <?php echo $mycc; ?>;
    color: #fff;
}
...
.sign-in-box .btn-sign-up{
    color: #fff;
    background-color: <?php echo $mycc; ?>;
    border: 1px solid <?php echo $mycc; ?>;
}
...
.home-banner-wrap .btn:hover{
    background: <?php echo $mycc; ?>;
    color: #fff;
}
.home-fact-area{
    background-color: <?php echo $mycc; ?>;
    background: -webkit-linear-gradient(-45deg,<?php echo $mycc; ?>,#6e1a52);
    background: -moz-linear-gradient(-45deg,<?php echo $mycc; ?> 0,#6e1a52 100%);
    background: -ms-linear-gradient(-45deg,<?php echo $mycc; ?> 0,#6e1a52 100%);
    background: -o-linear-gradient(-45deg,<?php echo $mycc; ?> 0,#6e1a52 100%);
    background: linear-gradient(-45deg,<?php echo $mycc; ?>,#6e1a52);
    color: #fff;
    padding: 15px 0;
    margin-bottom: 50px
}
...
.course-popover-content .popover-btns .wishlist-btn i {
    color: transparent;
    text-stroke: 1px <?php echo $mycc; ?>;
    -webkit-text-stroke: 1px <?php echo $mycc; ?>;
}
...
.footer-area{
    background-color: #fff;
    padding: 30px 0;
    border-bottom: 6px solid <?php echo $mycc; ?>;
    border-top: 1px solid #e8e9eb;
}
.copyright-text{
    color: #686f7a;
...
.course-bundle-box{
    background-color: <?php echo $mycc; ?>0d;
}
.text-ccc{
    color: #ccc !important;
}
